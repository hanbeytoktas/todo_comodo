...
/**
 * @author hanbey
 * @apiNote Controller of Authentication
 * */
...
public class AuthController {
    ...
    /**
     * @param loginRequest Request object of Login
     * @return if user exist then return jwt token
     * */
    @PostMapping("/signin")
    ...
    /**
     * @param signUpRequest Request object of register
     * @return if email not exist then user create and return success
     * */
    @PostMapping("/signup")
